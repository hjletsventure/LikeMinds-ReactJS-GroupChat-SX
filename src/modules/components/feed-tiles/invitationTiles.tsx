...
const GroupInviteTile = ({ title, response, id, refreshHomeFeed, localRefreshInviteList }: any) => {
  const userContext = useContext(UserContext);
  return (
    <div key={id} className="bg-white flex justify-between py-2.5 px-5 border-t border-[#EEEEEE] cursor-pointer">
      <Box>
        <Typography variant="body2" className="text-[#ADADAD] text-xs text-left font-normal">
